...
(custom-set-variables
 ...
 '(package-selected-packages
   '(agent-shell ajrepl auctex buttercup cape cdlatex citar cl-generic clj-refactor
                 clojure-ts-mode compile-angel consult-denote corfu csv-mode
                 dape difftastic diminish docker dockerfile-mode editorconfig
                 eglot elfeed elisp-lint embark-consult erc exec-path-from-shell
                 ...
                 which-key window-tool-bar zig-mode)))
(custom-set-faces
